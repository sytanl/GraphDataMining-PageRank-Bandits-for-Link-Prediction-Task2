...
if __name__ == '__main__':    
    ...
    prb = np.load('./results/eenet_results1.npy')
    prb_mean, prb_mean = get_mean_std(prb)
    plt.plot(x, prb_mean, 'k-', color='red',linewidth=2.0,linestyle='-', label = 'EE-Net')
    plt.fill_between(x, prb_mean-prb_mean, prb_mean+prb_mean, facecolor='red', alpha=0.2)
