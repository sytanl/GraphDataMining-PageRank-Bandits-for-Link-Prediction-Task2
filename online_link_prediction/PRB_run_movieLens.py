from baselines.load_data import load_movielen
...
if __name__ == '__main__':
    ...
    for i in range(runing_times):  
        ...
        G = np.load("./data/MovieLens/movie_2000users_10000items_noedge.npy")
        num_users = 2000
        num_items = 10000
        ...
        for t in tqdm(range(10000)): 
            ...
            ###############################################################################################
            idx_observe = [num_users + context_ind[i][1] for i in range(len(h_observe))]
    ...
    path = os.getcwd()    
    np.save('{}/results/PRB/Non_Full_Graph_Input/MovieLens/EvePPR_regrets.npy'.format(path), regrets_all)
