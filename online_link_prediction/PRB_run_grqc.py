from baselines.load_data import load_grqc
...
if __name__ == '__main__':
    ...
    for i in range(runing_times):  
        ...
        G = np.load("./data/GrQc/Insert/GrQc_ALLusers_noedge.npy")
    ...
    path = os.getcwd()    
    np.save('{}/results/PRB/10%_Graph_Input/GrQc/PRB2_regrets.npy'.format(path), regrets_all)
